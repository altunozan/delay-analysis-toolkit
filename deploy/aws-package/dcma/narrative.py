...
PROVIDERS: dict[str, dict] = {
    # GEMINI is the MANAGED default in this deployment: set
    # GEMINI_API_KEY (or GOOGLE_API_KEY) in the deployment's secrets
    # and every AI feature runs on it zero-click, the key held
    # server-side and never rendered — see ai_credentials_panel.
    "anthropic": {
...
def _stream_openai(api_key: str, model: str, prompt: str,
    ...
    # base_url lets any OpenAI-protocol endpoint reuse this path.
